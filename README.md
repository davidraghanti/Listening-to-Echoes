...
### 1. Enable Google Auth & Fix "Invalid Request"
...
*   `NEXT_PUBLIC_FIREBASE_PROJECT_ID`: Your unique project ID.
...
### 4. Podcast & RSS
When approving stories in the Librarian dashboard, enter the filename (e.g., `episode-001.mp3`) in the audio field. The RSS feed will automatically link it to your bucket:
