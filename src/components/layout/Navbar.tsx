      ...
      <div className="container mx-auto px-4">
        <div className="flex h-16 items-center justify-between">
          <Link href="/" className="flex items-center gap-3 group">
            <Logo iconClassName="h-10 group-hover:scale-105 transition-transform" />
            <span className="hidden sm:block font-headline text-xl font-bold tracking-tight text-foreground">
              Listening to Echoes
            </span>
          </Link>
